...
class CategoriesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('repayment_mode')
            ->maxLength('repayment_mode', 50)
            ->requirePresence('repayment_mode', 'create')
            ->notEmptyString('repayment_mode');
        ...
        $validator
            ->integer('soft_loan')
            ->requirePresence('soft_loan', 'create')
            ->notEmptyString('soft_loan');

        $validator
            ->numeric('soft_loan_sc')
            ->requirePresence('soft_loan_sc', 'create')
            ->notEmptyString('soft_loan_sc');

        $validator
            ->integer('normal_loan')
            ->requirePresence('normal_loan', 'create')
            ->notEmptyString('normal_loan');
